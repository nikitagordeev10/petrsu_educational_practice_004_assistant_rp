...
def add_task(subproject_name, task_creator, task_executor, task, state, comment, deadline):
    new_task = Task(subproject_name=subproject_name, task_creator=task_creator, task_executor=task_executor,
